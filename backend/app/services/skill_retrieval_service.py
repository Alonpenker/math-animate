from app.configs.llm_settings import RAG_RULE_CAP, RAG_TEMPLATE_CAP
...
class SkillRetrievalService:
    @staticmethod
    def retrieve(cursor, embed_text: str) -> CandidateResult:
        embedding = RAGService.embed_text(embed_text)
