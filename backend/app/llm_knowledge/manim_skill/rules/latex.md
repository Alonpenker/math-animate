...
6. **Prefer simple generated LaTeX** - For generated educational scenes, favor stable `MathTex` expressions and avoid custom templates or packages unless the active prompt explicitly calls for them.
